/**
 * Nuxt auto-imports named exports from utils/ (top level only, same rule
 * as composables/) - these are available everywhere with no import
 * statement needed.
 */
...
/** Relative "2 hours ago" / "3 days ago" style, for notifications and suggestions. */
